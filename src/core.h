...
struct InstrFuncPtrs {  // NOLINT(whitespace)
    void (*loadPtr)(THREADID, ADDRINT, ADDRINT /*Kasraa*/, UINT32);

    void (*storePtr)(THREADID, ADDRINT, ADDRINT /*Kasraa*/, UINT32);
    ...
    void (*predLoadPtr)(THREADID, ADDRINT, ADDRINT /*Kasraa*/, UINT32, BOOL);

    void (*predStorePtr)(THREADID, ADDRINT, ADDRINT /*Kasraa*/, UINT32, BOOL);
