...
void NullCore::LoadFunc(THREADID tid, ADDRINT addr, ADDRINT pc /*Kasraa*/, UINT32 size) {}

void NullCore::StoreFunc(THREADID tid, ADDRINT addr, ADDRINT pc /*Kasraa*/, UINT32 size) {}

void NullCore::PredLoadFunc(THREADID tid, ADDRINT addr, ADDRINT pc /*Kasraa*/, UINT32 size, BOOL pred) {}

void NullCore::PredStoreFunc(THREADID tid, ADDRINT addr, ADDRINT pc /*Kasraa*/, UINT32 size, BOOL pred) {}
